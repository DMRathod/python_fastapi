...
def create_post(post: UPosts, current_user:TokenData = Depends(get_current_user)):
...
def update_post(id: int, upost: UPosts, response: Response, current_user:TokenData = Depends(get_current_user)):
